        ...
        <Col md={8}>
          ...
          <Card className="mb-3">
            <Card.Body>
              ...
              <Card.Text>
                <strong>Card Number:</strong> {cart.paymentInfo.cardNumber}{' '}
                <br />
                <strong>Billing Zip:</strong> {cart.paymentInfo.billingZip}{' '}
                <br />
                <strong>Expiry Date:</strong> {cart.paymentInfo.expiryDate}
              </Card.Text>
